...
/**
* The {@code BSTdeluxe} class extends the {@code BST} class from the {@code algs4} library 
* by adding three tree traversal methods: pre-order, in-order, and post-order.
*
* The original {@code BST} class was authored by Robert Sedgewick and Kevin Wayne, 
* with [your name] contributing the additional traversal methods.
*
...
public class BSTdeluxe<Key extends Comparable<Key>, Value> {
    ...
    private void preOrderHelper(Node node, Queue<Key> queue) {
        ...
        queue.enqueue(node.key);  // Visit node
        preOrderHelper(node.left, queue);  // Left subtree
    ...
    public void inOrderHelper(Node node, Queue<Key> queue) {
        ...
        inOrderHelper(node.left, queue);  // Left subtree
        queue.enqueue(node.key);  // Visit node
    ...
    public void postOrderHelper(Node node, Queue<Key> queue) {
        ...
        postOrderHelper(node.left, queue);  // Left subtree
        postOrderHelper(node.right, queue); // Right subtree
        queue.enqueue(node.key);  // Visit node
    }
